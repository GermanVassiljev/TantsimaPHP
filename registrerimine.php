...
if (isset($_SESSION['username']) && isset($_SESSION['userid']))
    header("Location: ./tantsudPunktid.php");  // redirect the user to the home page
...
<form action="./registrerimine.php" class="form" method="POST">
    ...
    <div class="">
        ...
        if (isset($success) && $success){
            echo '<p color="green">Yay!! Your account has been created. <a href="./ab_login.php">Click here</a> to login!<p>';
        }
    ...
    <p class="center"><br />
        Already have an account? <a href="ab_login.php">Login here</a>
    </p>
</form>
